...
vtu_files = glob.glob(r"D:\ParcharmPlace\Smart-Particle-Group\VTU\*.vtu")
...
fig, axarr = plt.subplots(1, n_plot, figsize=(11, 8), sharex=True, sharey=True)
...
plt.tight_layout()
chart_file = 'jiangyuImages/plot.png'
