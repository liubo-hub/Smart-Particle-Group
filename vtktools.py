...
class vtu:
    ...
    def GetScalarField(self, name):
        ...
        try:
            ...
            try:
                ...
                raise Exception(
                    "ERROR: couldn't find point or cell scalar field data with name " + name + " in file " + self.filename + ".")
    ...
    def GetVectorField(self, name):
        ...
        try:
            ...
            try:
                ...
                raise Exception(
                    "ERROR: couldn't find point or cell vector field data with name " + name + " in file " + self.filename + ".")
        return arr([vtkdata.GetTuple3(i) for i in range(vtkdata.GetNumberOfTuples())])

    def WriteCellCentersToVTU(self, centers, output_filename):
        # Create a new point array to hold the cell center data
        points = vtk.vtkPoints()

        # Add each center to the points array
        for center in centers:
            points.InsertNextPoint(center)

        # Create a new unstructured grid to hold the cell centers
    ...
    def GetField(self, name):
        ...
        try:
            ...
            try:
                ...
                raise Exception(
                    "ERROR: couldn't find point or cell field data with name " + name + " in file " + self.filename + ".")
    ...
    def GetCellCenters(self):
        ...
        for i in range(self.ugrid.GetNumberOfCells()):
            # Get the cell
